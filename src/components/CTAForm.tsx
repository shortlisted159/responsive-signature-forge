...
export default function CTAForm({ signature, onUpdate }: CTAFormProps) {
  ...
  const [showCTAButton, setShowCTAButton] = useState(!!cta.text || !!cta.url);
    ...
    <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-2">
            <Switch 
              ...
              onCheckedChange={toggleCTAButton}
            />
            <Label htmlFor="cta-enabled" className="text-sm">
              {showCTAButton ? "Enabled" : "Disabled"}
            </Label>
          </div>
        </div>
      ...
      <div className="space-y-4 border-t pt-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="space-y-4">
            <p className="text-sm text-muted-foreground mb-2">Classic Layouts</p>
            <RadioGroup value={settings.layout} onValueChange={handleLayoutChange} className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                >
                  <div className="w-full h-16 bg-white border mb-2 flex items-center justify-center p-2">
                  ...
                  <div className="w-full h-16 bg-white border mb-2 flex flex-col items-center justify-center p-2">
                    ...
                    <div className="w-full flex gap-2 justify-center items-center">
                      ...
                      <div className="flex flex-col">
                        <div className="w-16 h-1.5 bg-slate-200 rounded mb-1"></div>
          ...
          <div className="space-y-4">
            <p className="text-sm text-muted-foreground mb-2">Minimal Layouts</p>
            <RadioGroup value={settings.layout} onValueChange={handleLayoutChange} className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
          ...
          <div className="space-y-4">
            <p className="text-sm text-muted-foreground mb-2">Professional Layouts</p>
            <RadioGroup value={settings.layout} onValueChange={handleLayoutChange} className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <Label 
                  ...
                  className="flex flex-col items-center justify-between rounded-md border-2 border-muted bg-slate-50 p-4 hover:bg-slate-100 hover:border-slate-200 peer-data-[state=checked]:border-brand-purple [&:has([data-state=checked])]:border-brand-purple"
                >
                  <div className="w-full h-16 bg-white border mb-2 flex items-center p-1">
                    <div className="w-1/3 h-full border-r flex items-center justify-center p-1">
